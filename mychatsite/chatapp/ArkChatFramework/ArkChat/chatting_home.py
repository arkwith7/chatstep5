...
class ChattingHomepage(ChatClient):
    ...
    def __init__(self, work_dir):
        ...
        self.intents_file_name = os.path.join(work_dir, "ArkChatFramework/ArkNLU/DialogIntents/intents_home_kr.json")
...
def home_NLULearning(work_dir):
    ...
    print("intents 파일 디렉토리[%s]" % os.path.join(work_dir, "ArkChatFramework/ArkNLU/DialogIntents/intents_home_kr.json"))

    input_file_name = os.path.join(work_dir, "ArkChatFramework/ArkNLU/DialogIntents/intents_home_kr.json")
